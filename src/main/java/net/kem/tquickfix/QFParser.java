...
//        MESSAGE_VERSION_TO_MESSAGE_MAPPER.put("FIX.5.0.SP2", tqf.v50sp2.QFMessageMapper.getInstance());
     ...
     * @see QFBuilderConfig#init(String)
     */
     ...
     * Use {@linkplain QFParser#getThreadContext()#hasErrors()} and {@linkplain QFParser#getThreadContext()#getErrors(ThreadContext.ErrorType)}

...
public class QFMessageClassBuilder extends QFComponentClassBuilder {
    ...
    protected CharSequence generateImports(ComponentTag componentGroupTag) {
        ...
        res
                ...
                .append(componentGroupTag.groupTags.isEmpty() ? "" : "import net.kem.tquickfix.blocks.QFGroup;\n")
//                .append("import net.kem.tquickfix.blocks.QFMessage;\n")
                .append("import net.kem.tquickfix.blocks.QFTag;\n")

...
//		}
        ...
        res
//                .append("import net.kem.tquickfix.QFParser;\n")
                .append("import net.kem.tquickfix.ThreadContext;\n")
                .append("import net.kem.tquickfix.blocks.QFComponent;\n")
                .append("import net.kem.tquickfix.blocks.QFField;\n")
                .append("import net.kem.tquickfix.builder.QFBuilderConfig;\n");
        if(componentGroupTag.groups != null) {
            res.append("import net.kem.tquickfix.blocks.QFGroup;\n");
        }
        res.append("import net.kem.tquickfix.blocks.QFTag;\n\n");

...
public interface QFComponentValidator {
    ...
    /**
     * This method is called <strong>before</strong> FIX tag parsing and allows to override the default parsing routine to the supplied tag-value pair.
     * This implementation does not override the default parsing routine and thus returns <em>null</em>.
     *
     * @param fixVersion    FIX version.
     * @param messageType   FIX message type.
     * @param tagKey   tag number
     * @param tagValue tag value
     * @return  {@link QFField} instance that should be used instead of one generated by the default parsing routine. In this case the routine will not be called.
     * If the method returns <em>null</em> then the default parsing routine will be applied as usual to this tag-value pair.
     */
    @Nullable default QFField beforeFieldParse(@NotNull CharSequence fixVersion, @NotNull CharSequence messageType, int tagKey, @NotNull String tagValue) {
        return null;
    }

    /**
     * This method is called <strong>after</strong> FIX tag parsing.
     * This implementation does not interfere with the parsed field and thus just returns the supplied field.
     * Normally, this method should be overrode
     *
     * @param fixVersion    FIX version.
     * @param messageType   FIX message type.
     * @param field   parsed {@link QFField} instance
     * @return  {@link QFField} instance that should be used instead of the given one.
     */
    @NotNull default QFField afterFieldParse(@NotNull CharSequence fixVersion, @NotNull CharSequence messageType, @NotNull QFField field) {
        return field;
    }

...
//        }
    ...
    private static final Map<CharSequence, QFFieldBlockDef> FIX_TYPE_TO_JAVA_BUILDING_BRICK = new HashMap<>();

    static {
        final QFFieldBlockDef BrickString = new QFFieldBlockDef(QFStringFieldElement.class, "QFField", String.class, null, null);
        final QFFieldBlockDef BrickCharacter = new QFFieldBlockDef(QFCharacterFieldElement.class, "QFField", Character.class, null, "value.charAt(0)");
        final QFFieldBlockDef BrickBigDecimal = new QFFieldBlockDef(QFFieldElement.class, "QFField", BigDecimal.class, "import java.math.BigDecimal;", "new BigDecimal(value)");
        final QFFieldBlockDef BrickInteger = new QFFieldBlockDef(QFFieldElement.class, "QFField", Integer.class, null, "Integer.parseInt(value)");
        final QFFieldBlockDef BrickDouble = new QFFieldBlockDef(QFFieldElement.class, "QFField", Double.class, null, "Double.parseDouble(value)");
        final QFFieldBlockDef BrickBoolean = new QFFieldBlockDef(QFBooleanFieldElement.class, "QFField", Boolean.class, null, "Boolean.parseBoolean(value)");
        final QFFieldBlockDef BrickFloat = new QFFieldBlockDef(QFFieldElement.class, "QFField", Float.class, null, "Float.parseFloat(value)");
        final QFFieldBlockDef BrickCurrency = new QFFieldBlockDef(QFFieldElement.class, "QFField", Currency.class, null, "java.util.Currency.getInstance(value)");

        final QFFieldBlockDef BrickDateTime = new QFFieldBlockDef(QFDateFieldElement.class, "QFDateTimeField", LocalDateTime.class, "import java.time.LocalDateTime;\nimport java.time.format.DateTimeParseException;", "getDateFormat().parse(value)");
        final QFFieldBlockDef BrickDate = new QFFieldBlockDef(QFDateFieldElement.class, "QFDateField", LocalDate.class, "import java.time.LocalDate;\nimport java.time.format.DateTimeParseException;", "getDateFormat().parse(value)");
        final QFFieldBlockDef BrickMonthYear = new QFFieldBlockDef(QFDateFieldElement.class, "QFMonthYearField", YearMonth.class, "import java.time.YearMonth;\nimport java.time.format.DateTimeParseException;", "getDateFormat().parse(value)");
        final QFFieldBlockDef BrickTime = new QFFieldBlockDef(QFDateFieldElement.class, "QFTimeField", LocalTime.class, "import java.time.LocalTime;\nimport java.time.format.DateTimeParseException;", "getDateFormat().parse(value)");
        ...
        FIX_TYPE_TO_JAVA_BUILDING_BRICK.put("LOCALMKTDATE", BrickDate);
        FIX_TYPE_TO_JAVA_BUILDING_BRICK.put("MONTHYEAR", BrickMonthYear);

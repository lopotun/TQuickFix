...
public class QFBuilderConfig {
    ...
    private void handleMapping(Map<CharSequence, Map<CharSequence, QFField.Validation>> mapping, String line, QFField.Validation validation) {
        // com.traiana.tquickfix.qf.component.PartiesComponentBase.noPartyIDs (group)
        // com.traiana.tquickfix.qf.component.PartiesComponentBase.NoPartyIDsGroupBase.partyID
        // com.traiana.tquickfix.qf.component.StandardHeaderComponentBase.senderCompID
        // com.traiana.tquickfix.qf.component.MDFullGrpComponentBase.NoMDEntriesGroupBase.rateSource (component)

...
//		res.append("import com.traiana.tquickfix.qf.field.").append(componentGroupTag.name).append(";\n");
...
//		}
//        res.append("import com.traiana.tquickfix.qf.field.").append(((GroupTag)componentGroupTag).firstGroupField.name).append(';').append("\n"); // import com.traiana.tquickfix.qf.field.QFFieldFld03;
//
//		for(QFComponentClassBuilder.NameReq group : componentGroupTag.groups) {
//			res.append("import com.traiana.tquickfix.qf.group.").append(group.name).append(';').append("\n"); // import com.traiana.tquickfix.qf.field.QFFieldFld03;
//		}
